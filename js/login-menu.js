...
let nombreSesionLoginMail;
let nombreSesionLoginUser;
...
btnJoinFree.addEventListener("click", () => {
    ...
    if((existeCorreo || existeUsuario || (!allLetter(primerNombre)) || (!allLetter(apellido)))){
        ...
        Swal.fire({
            ...
            '<div class="contenedor-btn-cyberarmy-alert"><button><h5><a href="./pages/cyber-army.html">CYBER ARMY</a></h5></button></div>' +
...
sendLogin.addEventListener("click", (event) => {
    ...
    if((existeMail || existeUser) && existePassword){
        ...
        if (existeMail){
            ...
            nombreSesionLoginMail = sessionStorage.getItem("inicioSesionLoginMail");
            ...
            nombreSesionLoginUser = sessionStorage.getItem("inicioSesionLoginUser");
            ...
            sesionDerecha.style.fontWeight = "550";
            sesionDerecha.style.fontFamily = "'Lato', sans-serif;"
            sesionDerecha.innerHTML = nombreSesionLoginUser;
            contenedorLoginSign.append(sesionDerecha);
...
const verificarSesion = () => { 
    ...
    if(nombreSesionLoginMail !== null){
        ...
        console.log("han iniciado sesion");
        
        botonLogin.remove()
        botonSign.remove()
        barraRegistro.remove()

    } else if (nombreSesionLoginUser !== null){
